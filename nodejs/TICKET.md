...
Treat the header as already verified — assume something upstream authenticated the caller. The stub attaches the claimed identity and nothing else; it doesn't reject anonymous requests. See `src/identity.js`.
