...
-- Orders
INSERT INTO orders (customer_name, customer_email, status, total_amount, payment_reference, created_at, updated_at)
VALUES ('John Smith', 'john.smith@email.com', 'CONFIRMED', 170.00, 'PAY-001-ABC', '2026-03-01 10:30:00', '2026-03-01 10:35:00');

INSERT INTO orders (customer_name, customer_email, status, total_amount, payment_reference, created_at, updated_at)
VALUES ('Jane Doe', 'jane.doe@email.com', 'CONFIRMED', 65.00, 'PAY-002-DEF', '2026-03-02 14:00:00', '2026-03-02 14:05:00');

INSERT INTO orders (customer_name, customer_email, status, total_amount, payment_reference, created_at, updated_at)
VALUES ('Bob Wilson', 'bob.wilson@email.com', 'PENDING', 55.00, NULL, '2026-03-05 09:00:00', '2026-03-05 09:00:00');

INSERT INTO orders (customer_name, customer_email, status, total_amount, payment_reference, created_at, updated_at)
VALUES ('Alice Brown', 'alice.brown@email.com', 'CANCELLED', 75.00, NULL, '2026-03-06 16:00:00', '2026-03-06 16:30:00');

INSERT INTO orders (customer_name, customer_email, status, total_amount, payment_reference, created_at, updated_at)
VALUES ('Emma Davis', 'emma.davis@email.com', 'CONFIRMED', 180.00, 'PAY-005-GHI', '2026-03-08 11:00:00', '2026-03-08 11:10:00');
